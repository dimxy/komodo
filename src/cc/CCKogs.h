...
#define KOGS_TIME_STALLED 3600 // sec
...
#define KOGS_TRY_OPRETURN_THEN_SEARCH_TOKEN_VOUT          (-1)
...
struct KogsBaseObject {
    ...
    int32_t blockHeightForSort; // set only when a list of txid retrieved
