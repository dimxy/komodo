...
/// @returns vout object
CTxOut MakeCC1vout(uint8_t evalcode, CAmount nValue, CPubKey pk, const vscript_t* pvData = NULL);
...
/// @param vData pointer to vector of vectors of unsigned char data to be added to the created vout for application needs
/// @returns vout object
CTxOut MakeCC1of2vout(uint8_t evalcode, CAmount nValue, CPubKey pk, CPubKey pk2, const vscript_t* pvData = NULL);

bool CCtoAnon(const CC *cond);

CTxOut MakeCC1voutMixed(uint8_t evalcode, CAmount nValue, CPubKey pk, const vscript_t *vData = NULL);
CTxOut MakeCC1of2voutMixed(uint8_t evalcode, CAmount nValue, CPubKey pk1, CPubKey pk2, const vscript_t *vData = NULL);
