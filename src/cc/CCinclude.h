...
struct CCcontract_info
{
    ...
    std::vector< struct CCVintxProbe > CCvintxprobes;  // stores probe cc's and privkeys to find vintx cc vouts and sign vins
...
//template <class T>
void CCLogPrintStream(const char *category, int level, const std::ostringstream &stream)
{
...
#define LOGSTREAM(category, level, logoperator) { std::ostringstream stream; logoperator; CCLogPrintStream( category, level, stream /*[=](std::ostringstream &stream) {logoperator;}*/ ); }
