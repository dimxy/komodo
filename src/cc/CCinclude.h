...
void SetCCunspentsCCIndex(std::vector<std::pair<CAddressUnspentCCKey, CAddressUnspentCCValue> > &unspentOutputs, const char *coinaddr, uint256 creationId);

/// SetCCunspents returns a vector of unspent outputs for a cc address
/// @param[out] unspentOutputs vector of pairs of objects CAddressUnspentCCKey and CAddressUnspentCCValue
/// @param coinaddr cc address where unspent outputs are searched
void SetCCunspentsCCIndex(std::vector<std::pair<CAddressUnspentCCKey, CAddressUnspentCCValue> > &unspentOutputs, const char *coinaddr);
