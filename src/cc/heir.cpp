...
/*
 ...
 A special 1of2 CC address is created that is freely spendable by the creator. The heir is only allowed to spend after the specified amount of idle blocks. 
 ...
 The design requires the heir to spend all the funds at once
*/
