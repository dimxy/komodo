        ...
        {   
            ...
            switch ( script[1] )
            {
                ...
                case 'R': // register
                    ...
                    if (GetCCaddress(cp,tmpaddress,oraclespk,true) || ConstrainVout(tx.vout[1],1,tmpaddress,0)) //As we don't know baton address before register is created, we check that it does not go to global pubkey!
