...
static asn_TYPE_member_t asn_MBR_Fulfillment_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Fulfillment, choice.secp256k1hashSha256),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Secp256k1hashFulfillment,
		0,	/* Defer constraints checking to the member type */
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"secp256k1hashSha256"
...
static const asn_TYPE_tag2member_t asn_MAP_Fulfillment_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* secp256k1hashSha256 */
    { (ASN_TAG_CLASS_CONTEXT | (15 << 2)), 7, 0, 0 } /* evalSha256 */
};
