...
public:
    ...
    bool UpdateAddressUnspentCCIndex(const std::vector<std::pair<CAddressUnspentCCKey, CAddressUnspentCCValue > >&vect);
    bool ReadAddressUnspentCCIndex(uint160 addressHash, uint256 creationid,
                                 std::vector<std::pair<CAddressUnspentCCKey, CAddressUnspentCCValue> > &vect, int32_t beginHeight, int32_t endHeight, int64_t maxOutputs);
};
